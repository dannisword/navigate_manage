type ButtonColor =
  ...
  | "warning"
  | "info";
type TextColorKey = Extract<
  ButtonColor,
  "contrast" | "success" | "danger" | "warning" | "info"
>;
// type OutlineHoverKey = Extract<
//   ButtonColor,
//   "contrast" | "success" | "danger" | "warning" | "info"
// >;
...
export const colorsBgLight = {
  ...
  success: "bg-emerald-700/80 border-emerald-500 text-white",
...
export const getButtonColor = (
  ...
  const colors = {
    ...
    bg: {
      ...
      contrast: "bg-gray-800 text-white dark:bg-white dark:text-black",
      success: "bg-emerald-700/80 dark:bg-emerald-500 text-white",
  ...
  if (isActive) {
    ...
    base.push(
      isOutlinedProcessed
        ? colors.text[color as TextColorKey]
        : colors.bg[color]
    );
  }
  ...
  if (hasHover) {
    base.push(
      isOutlinedProcessed
        ? colors.outlineHover[color as TextColorKey]
